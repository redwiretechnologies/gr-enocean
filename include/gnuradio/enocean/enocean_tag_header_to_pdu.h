...
namespace gr {
  namespace enocean {
    ...
    /*!
     * \brief This block tages a tagged stream from a correlate access block, reads the packet length and then builds a PDU packet of the reminaing number data.
     * \ingroup enocean
     *
     */
